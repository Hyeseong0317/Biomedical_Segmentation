...
#### Leaky ReLU와 ReLU의 큰 차이는 없다. Sigmoidal보다는 Rectified activation function을 쓴다. Sigmoid가 -1, 1부근에서 gradient가 0으로 수렴하여 hidden layer의 가중치가 업데이트되지 않는 gradient vanishing 문제를 해결할 수 있다.
