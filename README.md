...
#### L2와 L1은 blurry한 image를 생성한다. Highfrequency는 잘 못잡는 반면에 low frequencies는 정확하게 잡아낸다. L1 또는 L2 loss를 사용하면 low frequencies를 잡는데 새로운 프레임워크를 필요로 하지 않는다. (Loss 구성시 매우 좋은 아이디어)
