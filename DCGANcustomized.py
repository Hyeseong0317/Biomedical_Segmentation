# -*- coding: utf-8 -*-
"""
DCGAN Customized for medical image by Hyeseong Kim
==============
...
dataroot = "/mnt/intern/3D_vessel/demo_code/data/test/original2DforDCGAN"
...
ani.save('DCGAN_practice.gif', writer='imagemagick')
